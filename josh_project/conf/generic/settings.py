...
ROOT_URLCONF = 'josh_project.conf.urls.main'
...
WSGI_APPLICATION = 'josh_project.conf.wsgi.app.application'
...
# Logging
LOG_PATH = os.path.join(VIRTUALENV_DIR, 'var/log/django/josh_project.log')
...
DEFAULT_FROM_EMAIL = 'admin@josh_project.com'
